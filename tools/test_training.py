...
def parse_config():
    ...
    parser.add_argument('--lownms', action='store_true', default=True, help='lownms')
...
def main():
    ...
    eval_output_dir = output_dir / 'eval_train'
    ...
    test_set, test_loader, sampler = build_dataloader(
        ...
        dist=dist_test, workers=args.workers, logger=logger, training=False, test_training=True
    )
    if args.lownms:
        try:
            cfg.MODEL.POST_PROCESSING.NMS_CONFIG.NMS_THRESH = cfg.ALSSL_TRAIN.POST_PROCESSING_NMS_THRESH
        except AttributeError:
            cfg.MODEL.POST_PROCESSING.NMS_CONFIG.NMS_THRESH = 0.1
