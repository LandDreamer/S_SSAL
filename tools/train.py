...
def parse_config():
    ...
    parser.add_argument('--random_seed', type=int, default=666, help='')
...
def main():
    ...
    if 'ALSSL_TRAIN' in cfg and cfg.ALSSL_TRAIN.get('SELECT_TYPE', 'frame') == 'box':
        cfg.DATA_CONFIG.REPEAT = int(cfg.DATA_CONFIG.REPEAT * (args.al_round+1))
