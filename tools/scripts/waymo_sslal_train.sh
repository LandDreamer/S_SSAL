...
# AL sampling
python al_sampling.py --construct_set gt --extra_tag box5000normalpretrain \
 --cfg cfgs/al_waymo/pv_rcnn_al_cal_normalpretrain_box5000.yaml \
 --pretrained_model ../output/waymo_selected_labels/pv_rcnn_pretrain_selected_box5000/box5000normalpretrain/ckpt/checkpoint_epoch_30.pth


# Final model deliver
# python train_selected_labels.py --extra_tag box5000normalpretrain --cfg cfgs/al_waymo/pv_rcnn_al_cal_normalpretrain_box5000.yaml \
#  --batch_size 2  
...
python construct_ssl_database.py  --extra_tag box5000normalpretrain --extra_tag_2 database \
 --cfg cfgs/sslal_waymo/pv_rcnn_al_cal_normalpretrain_box5000_cpsp.yaml \
 --pretrained_model ../output/al_waymo/pv_rcnn_al_cal_normalpretrain_box5000/box5000normalpretrain/ckpt/checkpoint_epoch_30.pth

python train_ssl.py --batch_size 2 --extra_tag box5000normalpretrain \
 --cfg cfgs/sslal_waymo/pv_rcnn_al_cal_normalpretrain_box5000_cpsp.yaml \
 --pretrained_model ../output/al_waymo/pv_rcnn_al_cal_normalpretrain_box5000/box5000normalpretrain/ckpt/checkpoint_epoch_30.pth
