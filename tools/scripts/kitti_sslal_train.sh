...
# AL sampling
python al_sampling.py --construct_set gt --extra_tag box200normalpretrain  \
 --cfg cfgs/al_kitti/pv_rcnn_al_cal_normalpretrain_box200.yaml \
 --pretrained_model ../output/kitti_selected_labels/pv_rcnn_pretrain_selected/box200normalpretrain/ckpt/checkpoint_epoch_80.pth

# Final model deliver
python train_selected_labels.py --extra_tag box200normalpretrain --cfg cfgs/al_kitti/pv_rcnn_al_cal_normalpretrain_box200.yaml \
 --batch_size 2  

python construct_ssl_database.py  --extra_tag box200normalpretrain --extra_tag_2 database \
 --cfg cfgs/sslal_kitti/pv_rcnn_al_cal_normalpretrain_box200_cpsp.yaml \
 --pretrained_model ../output/al_kitti/pv_rcnn_al_cal_normalpretrain_box200/box200normalpretrain/ckpt/checkpoint_epoch_80.pth

python train_ssl.py --batch_size 2 --extra_tag box200normalpretrain \
 --cfg cfgs/sslal_kitti/pv_rcnn_al_cal_normalpretrain_box200_cpsp.yaml \
 --pretrained_model ../output/al_kitti/pv_rcnn_al_cal_normalpretrain_box200/box200normalpretrain/ckpt/checkpoint_epoch_80.pth