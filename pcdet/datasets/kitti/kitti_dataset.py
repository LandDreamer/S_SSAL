...
class KittiDataset(DatasetTemplate):
    ...
    def get_cer_info(self, sample_idx):
        ...
        return self.kitti_infos[info_idx]

    def get_sampleid_2_infoidx(self):
        if len(self.sampleid_2_infoidx) != len(self.kitti_infos):
            self.sampleid_2_infoidx = {info['point_cloud']['lidar_idx']: idx for idx, info in enumerate(self.kitti_infos)}
