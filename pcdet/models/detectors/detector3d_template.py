    ...
    def post_processing(self, batch_dict, no_recall_dict=False, override_thresh=None, no_nms=False):
        ...
        for index in range(batch_size):
            ...
            if post_process_cfg.NMS_CONFIG.MULTI_CLASSES_NMS:
                ...
                if shared_features is not None:
                    final_boxes_features =\
                        shared_features.view(batch_size, -1, shared_features.shape[-2])[batch_mask][selected]
            ...
            record_dict = {
                ...
                'box_features': final_boxes_features,
                'shared_features': shared_features,
                'pts_count': pts_counts,
                'box_volumes': box_volumes,
                'pred_embeddings': final_boxes_features,
