...
class PVRCNN_SSL_ProGT(PVRCNN_SSL):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        assert 'RANDOM_TYPE' in model_cfg.SSL_Thresh
        self.random_type = model_cfg.SSL_Thresh.RANDOM_TYPE
            ...
            with torch.no_grad():
                ...
                for ind in unlabeled_mask:
                    ...
                    if self.random_type == 0:
                        ...
                        valid_inds = pseudo_score > random_thresh
                    elif self.random_type == 1:
                        random_thresh = pseudo_score.new_tensor(np.random.random(pseudo_score.shape[0]))
                        valid_inds = pseudo_score > random_thresh                    
